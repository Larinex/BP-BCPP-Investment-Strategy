...
SCREENING_SOUBOR = os.path.join(BASE_DIR, 'screening.xlsx')
POMOCNA_SOUBOR   = os.path.join(BASE_DIR, 'pomocna_data_no_lookahead_analyza.xlsx')
OUTPUT_FILE      = os.path.join(BASE_DIR, 'no_lookahead_output.xlsx')
