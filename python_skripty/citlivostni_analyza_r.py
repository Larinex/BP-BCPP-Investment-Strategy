...
INPUT_DATA      = os.path.join(BASE_DIR, 'pomocná data.xlsx')
INPUT_BONDS     = os.path.join(BASE_DIR, 'dluhopisy.xlsx')
OUTPUT_FILE     = os.path.join(BASE_DIR, 'sensitivity_output.xlsx')
